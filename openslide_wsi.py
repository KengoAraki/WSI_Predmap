...
# 予測画像用のパッチ切り取り
def split_patch_for_predmap():
    parent_dir = "/mnt/ssdsub1/strage/src/MF0012/"
    p_parent_dir = pathlib.Path(parent_dir)
    output_main_dir = parent_dir.replace("src/", "Patch/")
